...
a_slice_2 = Annotations(
    [Ellipse(Point(128, 256), 20, 20, "Millimeter", 1)], [], volume[1]
)
a_slice_3 = Annotations(
    [Ellipse(Point(128, 276), 30, 30, "Millimeter", 1)], [], volume[2]
)
a_slice_4 = Annotations(
    [Ellipse(Point(128, 296), 40, 40, "Millimeter", 1)], [], volume[3]
)
